#ifndef MINISTL_TEST_MULTISET_H
#define MINISTL_TEST_MULTISET_H

#include "stl_multiset.imp.h"
#include <iostream>
...
namespace MiniSTL {
    void test_multiset() {
        ...
        MiniSTL::multiset<int> iset(ia, ia + 5);
        cout << "MiniSTL::multiset<int>(ia, ia + 5)" << endl;
